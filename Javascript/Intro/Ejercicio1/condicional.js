...
var bella_o_bestia = prompt("¿Eres bellisimo/a?")

if(bella_o_bestia === "si")
{
    alert("Ciertamente")
}else if(bella_o_bestia === "no"){
    alert("No te creo")
}
*/
...
if((numero % 2) == 0)
{
    alert("El numero " +numero +" SI es PAR")
}else {
...
var numero_cliente = prompt("Ingresa tu numero de cliente")
if(numero_cliente == 1000)
{
    alert("Ganaste un premio")
}else {
    alert(numero_cliente + ". Lo sentimos, sigue participando ")
}
*/

/*
5. Solicitar al usuario que ingrese dos números 
    y mostrar cuál de los dos es menor. 
    No considerar el caso en que ambos números son iguales.

var numero_A = prompt("Ingresa tu primer numero")
var numero_B = prompt("Ingresa tu segundo numero")

if(numero_A < numero_B)
{
    alert("El numero menor es:" + numero_A)
}else if(numero_A > numero_B ){
    alert("El numero menor es:" + numero_B)
}
*/

/*
6. Solicitar al usuario que ingrese tres números 
...
var numero_A = prompt("Ingresa tu primer numero")
var numero_B = prompt("Ingresa tu segundo numero")
var numero_C = prompt("Ingresa tu tercer numero")

var INTnumero_A = parseInt(numero_A)
var INTnumero_B = parseInt(numero_B)
var INTnumero_C = parseInt(numero_C)

if(INTnumero_A > INTnumero_B && INTnumero_A > INTnumero_C)
{
    alert("El numero mayor es:" + INTnumero_A)
}else if(INTnumero_B > INTnumero_A && INTnumero_B > INTnumero_C){
    alert("El numero mayor es:" + INTnumero_B)
}else if(INTnumero_C > INTnumero_A && INTnumero_C > INTnumero_B){
    alert("El numero mayor es:" + INTnumero_C)
}
*/
